...
const coffeeMarkerSVG = (price) => `
  <svg viewBox="0 0 110 120" width="60" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="80" cy="25" r="22" fill="#F6F5F5" stroke="#8BA5C1" stroke-width="2"/>
    <text x="80" y="25" font-family="Work Sans, sans-serif" font-size="11" font-weight="600"
          fill="#8BA5C1" text-anchor="middle" dominant-baseline="central">${price}</text>
  </svg>
`;
...
const matchaMarkerSVG = (price) => `
  <svg viewBox="0 0 110 120" width="60" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="80" cy="25" r="22" fill="#F6F5F5" stroke="#8BA5C1" stroke-width="2"></circle>
    <text x="80" y="25" font-family="Work Sans, sans-serif" font-size="11" font-weight="600"
          fill="#8BA5C1" text-anchor="middle" dominant-baseline="central">${price}</text>
  </svg>
`;
